...
class LightsSystem {
	public:
		LightsSystem(byte pin_front_lights, byte pin_back_lights, byte pin_left_blinking_lights, byte pin_right_blinking_lights, unsigned long period_blinking_lights);
