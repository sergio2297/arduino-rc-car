...
LightsSystem::LightsSystem(byte pin_front_lights, byte pin_back_lights, byte pin_reverse_lights, byte pin_left_blinking_lights, byte pin_right_blinking_lights, unsigned long period_blinking_lights)
	: led_front_lights(pin_front_lights), led_back_lights(pin_back_lights), led_reverse_lights(pin_reverse_lights), 
	  led_left_blinking_lights(pin_left_blinking_lights, period_blinking_lights), led_right_blinking_lights(pin_right_blinking_lights, period_blinking_lights), 
...
void LightsSystem::turn_reverse_lights(bool state) {
    if(state == true) {
        led_reverse_lights.turnOn();
    } else {
        led_reverse_lights.turnOff();
    }
}
